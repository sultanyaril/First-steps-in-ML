...
def run_single_test(data_dir, output_dir):
    ...
    if os.path.exists(os.path.join(data_dir, 'task1_vectorised')): 
        for i in range(6):
            ...
            tick = time.time()
            res = functions_vectorised.prod_non_zero_diag(x)
        ...
        for i in range(6):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            res = functions.prod_non_zero_diag(x.tolist())
            data = {'res': res}
            with open(os.path.join(output_dir, f'output_{i}.pkl') , 'wb') as f:
                pickle.dump(data, f)
        ...
        for i in range(6):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            tick = time.time()
            res = functions_vectorised.max_after_zero(x)
            res_time = time.time() - tick
            data = {'res': res, 'time': res_time}
        ...
        for i in range(6):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            res = functions.max_after_zero(x.tolist())
            data = {'res': res}
    ...
    if os.path.exists(os.path.join(data_dir, 'task5_vectorised')): 
        for i in range(5):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            tick = time.time()
            res = functions_vectorised.run_length_encoding(x)
            res_time = time.time() - tick
            data = {'res': res, 'time': res_time}
        ...
        for i in range(5):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            res = functions.run_length_encoding(x.tolist())
            data = {'res': res}
        ...
        for i in range(3):
            ...
            y = np.load(os.path.join(data_dir, f'input_{i}', 'y.npy'))
            tick = time.time()
            res = functions_vectorised.pairwise_distance(x, y)
            res_time = time.time() - tick
            data = {'res': res, 'time': res_time}
        ...
        for i in range(3):
            x = np.load(os.path.join(data_dir, f'input_{i}', 'x.npy'))
            y = np.load(os.path.join(data_dir, f'input_{i}', 'y.npy'))
            res = functions.pairwise_distance(x.tolist(), y.tolist())
            data = {'res': res}
    ...
    if os.path.exists(os.path.join(output_dir, 'task1_vectorised')):
        for i in range(6):
            ...
            if type(data['res']) not in (int, np.integer, np.int32, np.int64):
                res = f'functions_vectorised.py, prod_non_zero_diag: Wrong answer type'
                print(res)               
                return res
            
            # check answer
            if data['res'] != gt_data['res']:
                res = f'functions_vectorised.py, prod_non_zero_diag: Wrong answer on test {i}'
                print(res)               
                return res
            ...
            if i == 5:
                if data['time'] > tol * gt_data['time']:
                    res = f"functions_vectorised.py, prod_non_zero_diag: Your solution is too slow! Execution time on test {i} is {data['time']:.4f} sec"
                    print(res)
                    return res  
        
        res = 'Ok'
        print('functions_vectorised.py, prod_non_zero_diag: Ok')   
        ...
        for i in range(6):
            ...
            # check type
            if type(data['res']) not in (int, np.integer, np.int32, np.int64):
                res = f'functions.py, prod_non_zero_diag: Wrong answer type'
                print(res)               
                return res

            # check answer
            if data['res'] != gt_data['res']:
                res = f'functions.py, prod_non_zero_diag: Wrong answer on test {i}'
                print(res)               
                return res
        
        res = 'Ok'
        print('functions.py, prod_non_zero_diag: Ok')   
        ...
        for i in range(6):
            ...
            # check type
            if type(data['res']) not in (int, np.integer, np.int32, np.int64):
                res = f'functions_vectorised.py, max_after_zero: Wrong answer type'
                print(res)               
                return res

            # check answer
            if data['res'] != gt_data['res']:
                res = f'functions_vectorised.py, max_after_zero: Wrong answer on test {i}'
                print(res)
                return res
            ...
            if i == 5:
                if data['time'] > tol * gt_data['time']:
                    res = f"functions_vectorised.py, max_after_zero: Your solution is too slow! Execution time on test {i} is {data['time']:.4f} sec"
                    print(res)
                    return res      

        res = 'Ok'
        print('functions_vectorised.py, max_after_zero: Ok')
        ...
        for i in range(6):
            ...
            # check type
            if type(data['res']) not in (int, np.integer, np.int32, np.int64):
                res = f'functions.py, max_after_zero: Wrong answer type'
                print(res)               
                return res

            # check answer
            if data['res'] != gt_data['res']:
                res = f'functions.py, max_after_zero: Wrong answer on test {i}'
                print(res)
                return res
           

        res = 'Ok'
        print('functions.py, max_after_zero: Ok')
        ...
        for i in range(4):
            ...
            # check answer
            if ((len(data['res']) != len(gt_data['res'])) or 
        ...
        for i in range(5):
            ...
            # check type
            if ((type(data['res']) != tuple) or (len(data['res']) != 2) or 
                (type(data['res'][0]) != np.ndarray) or (type(data['res'][1]) != np.ndarray)):
                res = f'functions_vectorised.py, run_length_encoding: Wrong answer type'
                print(res)               
                return res

            # check answer
            if ((len(data['res'][0]) != len(gt_data['res'][0]) or 
                len(data['res'][0]) != len(gt_data['res'][0])) or (not np.allclose(data['res'][0], gt_data['res'][0])) or 
                (not np.allclose(data['res'][1], gt_data['res'][1]))):
                res = f'functions_vectorised.py, run_length_encoding: Wrong answer on test {i}'
                print(res)
                return res
            ...
            if i == 4:
                if data['time'] > tol * gt_data['time']:
                    res = f"functions_vectorised.py, run_length_encoding: Your solution is too slow! Execution time on test {i} is {data['time']:.4f} sec"
                    print(res)
                    return res      

        res = 'Ok'
        print('functions_vectorised.py, run_length_encoding: Ok')   
        ...
        for i in range(5):
            ...
            # check type
            if ((type(data['res']) != tuple) or (len(data['res']) != 2) 
                or (type(data['res'][0]) != list) or (type(data['res'][1]) != list)):
                
                res = f'functions.py, run_length_encoding: Wrong answer type'
                print(res)               
                return res
            ...
            if ((len(data['res'][0]) != len(gt_data['res'][0]) or 
                len(data['res'][0]) != len(gt_data['res'][0])) or (not np.allclose(data['res'][0], gt_data['res'][0])) or 
                (not np.allclose(data['res'][1], gt_data['res'][1]))):
                res = f'functions.py, run_length_encoding: Wrong answer on test {i}'
                print(res)
                return res

        res = 'Ok'
        print('functions.py, run_length_encoding: Ok')   
        ...
        for i in range(3):
            ...
            # check type
            if type(data['res']) != np.ndarray:
                res = f'functions_vectorised.py, pairwise_distance: Wrong answer type'
                print(res)               
                return res
            ...
            if ((len(data['res']) != len(gt_data['res'])) or 
                (not np.allclose(data['res'], gt_data['res']))):
                res = f'functions_vectorised.py, pairwise_distance: Wrong answer on test {i}'
                print(res)
                return res
            ...
            if i == 2:
                if data['time'] > tol * gt_data['time']:
                    res = f"functions_vectorised.py, pairwise_distance: Your solution is too slow! Execution time on test {i} is {data['time']:.4f} sec"
                    print(res)
                    return res      

        res = 'Ok'
        print('functions_vectorised.py, pairwise_distance: Ok')  
        ...
        for i in range(3):
            ...
            if ((len(data['res']) != len(gt_data['res'])) or 
                (not np.allclose(data['res'], gt_data['res']))):
                res = f'functions.py, pairwise_distance: Wrong answer on test {i}'
                print(res)
                return res 

        res = 'Ok'
        print('functions.py, pairwise_distance: Ok') 
